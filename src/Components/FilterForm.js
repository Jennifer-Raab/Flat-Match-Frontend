...
console.log("setContent", setContent)
    ...
    return (
        ...
        <input type="checkbox" name="toggle" id="toggle" className="hid-checkb"></input>
        <label htmlFor="toggle" className="button-style">Filter</label>
    <form className="filter-form" onSubmit={handleSubmit}>
        <fieldset>
            ...
            <div>
                ...
                <input type="number" name="numberOfPersons" id="numberOfPersons" min="1" max="10" value={numberOfPersons} onChange={handleChange}></input>
            </div>
            <div>
                <label htmlFor="rent">
                { type === "offer" ? "Maximale Miethöhe" : "Minimale Miethöhe" }
                </label>
                <input type="number" name="rent" id="rent" min="0" max="10000" value={rent} onChange={handleChange}></input>
            </div>
        </fieldset>
            <div className="button-container">
                <input type="hidden" name="type" id="type" value={type}></input>
                <button type="submit" className="button-style">Filter anwenden</button>
            </div>
      </form>
        </div>
    );
