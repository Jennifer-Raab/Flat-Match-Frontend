  ...
  return (
    <div>
      ...
      <section>
              ...
              return (
                <div key={offer.id} className="flat-card-userpage">
                  <Link to={`/angebot/${offer.id}`}>
                    ...
                    <input type="checkbox" id={`offer_aktiv_${offer.id}`}></input><label for={`offer_aktiv_${offer.id}`}>Klick</label>
        ...
        { offers.length > 3 ? <button onClick={expand} class="button-2"></button> : "" }
      </section> : ""
       }
